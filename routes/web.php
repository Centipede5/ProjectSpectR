...
Route::post('/oniadmin/manageRoles', 'SuperAdminController@updateRoles');
Route::post('/oniadmin/searchUser', 'SuperAdminController@searchUser');
Route::post('/oniadmin/updateUser', 'SuperAdminController@updateUser');
