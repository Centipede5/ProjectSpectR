...
class IGDB
{
     ...
     * @throws \Exception
     */
    public function getPlatform($platformId, $fields = ['name','logo','slug','url','created_at','updated_at','shortcut','website','summary','category','product_family','alternative_name','generation','versions'])
    {
