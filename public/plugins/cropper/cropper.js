    ...
    Cropper.prototype = {
        ...
        afterUpload: function(data){
            ...
            if (response.status === 'error') {
                ...
                if(message.substring(0,10) === "LOGGED OUT"){
        ...
        createModal: function(){
            ...
            var modalHTML =  '<div id="cropperModal">'+'<div id="cropperModalObj" style="width:'+ that.objW +'px; height:'+ that.objH +'px; margin:0 auto; margin-top:'+ marginTop +'px; position: relative;"> </div>'+'</div>';

            $('body').append(modalHTML);

            that.modal = $('#cropperModal');

            that.obj = $('#cropperModalObj');
