          ...
          <div class="widget widget-about">
            ...
            <ul>
              ...
              @if(isset($user_info->social_meta->website))
                <li><a href="{{ $user_info->social_meta->website }}" class="website-link" target="_blank"><i class="fas fa-link website-link"></i>{{ $user_info->social_meta->website_display }}</a></li>
              @endif
